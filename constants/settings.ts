export const SETTINGS_CONFIG = [
  ...
  { id: 'openSource', translKey: 'openSource', type: 'nav', screen: 'openSource' },
...
export const CREDITS_ITEMS = [
  ...
  { id: 'programmers', title: 'Programmers', value: 'Yen Han, June Chun', align: 'right', multiline: true },
  { id: 'designer', title: 'UI/UX Designer', value: 'Jenny Kim', align: 'right' },
  { id: 'qaTesters', title: 'QA Testers', value: 'YC, SJ', align: 'right' },
  { id: 'localizationManagers', title: 'Localization Managers', value: 'Mary, Carol, Ann, Edward', align: 'right', multiline: true },
  { id: 'specialThanks', title: 'Special Thanks', value: 'Toronto Korean Developers, Minji Kim', align: 'left', multiline: true },
];
...
export const APPS_LIST = [
  { name: 'Sky Peacemaker - Finger Force', image: require('@/assets/images/sky_peacemaker.png'), url: 'https://skypeacemaker.onelink.me/YQxG/8s9sx66i' },
  { name: 'World Movie Trailer', image: require('@/assets/images/world_movie_trailer.png'), url: 'https://wmt.onelink.me/YPN9/m428wgpq' },
  { name: 'World Book Ranking', image: require('@/assets/images/world_book_ranking.png'), url: 'https://worldbookranking.onelink.me/so3H/gftf32rq' },
  { name: 'Simply Multi Timer', image: require('@/assets/images/simply_multi_timer.png'), url: 'https://simplymultitimer.onelink.me/6kU2/v7i9ke1m' },
  { name: 'Wisdom Qclock', image: require('@/assets/images/wisdom_qclock.png'), url: 'https://wisdomqclock.onelink.me/SVr2/b7gs4og1' },
  { name: 'Find Four', image: require('@/assets/images/find_four.png'), url: 'https://findfour.onelink.me/vurA/0tfteiuf' },
  { name: 'Dual Flashlight', image: require('@/assets/images/dual_flashlight.png'), url: 'https://dualflashlight.onelink.me/7gkq/qpbc8y65' },
  { name: 'decibella', image: require('@/assets/images/decibella.png'), url: 'https://decibella.onelink.me/Ve6i/vydwhkh4' },
];